...
<div>
    ...
    <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
      ...
      <div class="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt class="truncate text-sm font-medium text-gray-500">Snapshotters</dt>
            ...
            <div class="min-w-0 flex-1 sm:flex sm:items-center sm:justify-between">
              <div class="truncate">
                ...
                <div class="mt-2 flex">
                  <div class="ml-2 flex flex-shrink-0">
                    {#if epoch.finalized}
                    <p class="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">finalized</p>
                    {:else}
              ...
              <div class="mt-4 flex-shrink-0 sm:mt-0 sm:ml-5">
                <div class="flex -space-x-1 overflow-hidden">
                  ...
                  <img class="inline-block h-6 w-6 rounded-full ring-2 {snapshotter.submissionStatus == 'WITHIN_SCHEDULE' ? 'ring-white': 'ring-red'}" alt="{snapshotter.snapshotterInstanceID}" src="https://avatars.dicebear.com/api/identicon/{snapshotter.snapshotterInstanceID}.png">
                  {/each}
                <!--
